...
"""
Source: https://discuss.pytorch.org/t/how-to-debug-causes-of-gpu-memory-leaks/6741/4
"""
...
def debug_method(method_name, gpu='0'):
    os.environ['GPU_DEBUG'] = gpu
    os.environ['TRACE_INTO'] = method_name
