...
class CombinationTrainer:
    def __init__(self,
        ...
        self.encoder_path = os.path.join(experiment_log_dir.rsplit('/', 1)[0], '.temp',
                                         experiment_log_dir.rsplit('/', 1)[1], 'encoder.pth')
        self.decoder_path = os.path.join(experiment_log_dir.rsplit('/', 1)[0], '.temp',
                                         experiment_log_dir.rsplit('/', 1)[1], 'decoder.pth')
        self.qf1_path = os.path.join(experiment_log_dir.rsplit('/', 1)[0], '.temp',
                                     experiment_log_dir.rsplit('/', 1)[1], 'qf1.pth')
        self.qf2_path = os.path.join(experiment_log_dir.rsplit('/', 1)[0], '.temp',
                                     experiment_log_dir.rsplit('/', 1)[1], 'qf2.pth')
