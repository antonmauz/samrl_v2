...
def get_grid_rolls_out():
    ...
    return GroupRepresentations(representations, "GridRollsOut")

def get_grid_rolls_in():
    perm = np.zeros((4, 4))
    permutes = [[1, 2, 3, 0],
                [2, 3, 0, 1],
                [3, 0, 1, 2]]
    ...
    representations = [torch.FloatTensor(np.eye(4)),
                       ...
                       torch.FloatTensor(perms[1]),
                       torch.FloatTensor(perms[2])]
    return GroupRepresentations(representations, "GridRollsIn")
