...
def plot_encodings_split(epoch, exp_directory, save=False, normalize=False, legend=False, show=True, save_wandb=False,
                         encoding_storage = None):
